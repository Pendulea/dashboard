...
import { BLACK, BLUE, FLASHY_GREEN, RED, WHITE_GREY } from '../constants';
...
const Button = (props: IProps) => (
    <Btn className="noselect" style={props.style} disabled={props.disabled || !!props.loading} color={props.color} loading={props.loading ? 1 : 0} onClick={props.onClick}>
...
interface IProps {
    color: 'white' | 'green' | 'blue' | 'black' | 'red' 
    title: string
    disabled?: boolean
    icon?: string
    onClick?: any
